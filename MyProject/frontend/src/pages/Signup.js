      ...
      <div className="w-full max-w-sm bg-white m-auto flex items-center flex-col p-4">
        ...
        <form className="w-full py-3 flex flex-col"onSubmit={handleSubmit}>
          ...
          <div className="flex px-2 py-1 bg-slate-200 mt-1 mb-2 rounded focus-within:outline focus-within:outline-blue-300">
            ...
            >
              {showConfrimPassword ? <IoMdEye /> : <IoMdEyeOff />}
            </span>
          </div>

          <button className="max-w-[120px] m-auto w-full bg-red-500 hover:bg-red-600 cursor-pointer text-white text-xl font-medium text-center py-1 rounded-full mt-4">
            Sign up
          </button>
        </form>
